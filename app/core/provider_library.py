...
PROVIDERS: list[dict] = [
    ...
    {"slug": "paddle", "name": "Paddle", "url": "https://www.paddle.com/legal/sub-processors",
     "description": "Payments and merchant of record", "category": "Payments",
     "accent": "bg-blue-100 text-blue-700", "verified": False},
    {"slug": "shopify", "name": "Shopify", "url": "https://www.shopify.com/legal/subprocessors",
    ...
    {"slug": "sendgrid", "name": "SendGrid", "url": "https://www.twilio.com/en-us/legal/sub-processors",
     ...
     "accent": "bg-blue-100 text-blue-700", "verified": True},
    {"slug": "mailchimp", "name": "Mailchimp", "url": "https://mailchimp.com/legal/data-processing-addendum/",
    ...
    {"slug": "datadog", "name": "Datadog", "url": "https://www.datadoghq.com/legal/sub-processors/",
    ...
    {"slug": "amplitude", "name": "Amplitude", "url": "https://amplitude.com/legal/sub-processors",
     "description": "Product analytics", "category": "Observability",
     "accent": "bg-blue-100 text-blue-700", "verified": False},

    {"slug": "auth0", "name": "Auth0", "url": "https://auth0.com/docs/secure/data-privacy-and-compliance/gdpr/subprocessors",
     "description": "Authentication and identity", "category": "Identity",
     "accent": "bg-orange-100 text-orange-700", "verified": False},
    {"slug": "okta", "name": "Okta", "url": "https://www.okta.com/agreements/",
     "description": "Single sign-on and identity", "category": "Identity",
     "accent": "bg-sky-100 text-sky-700", "verified": False},

    {"slug": "slack", "name": "Slack", "url": "https://slack.com/trust/data-management/subprocessors",
    ...
    {"slug": "atlassian", "name": "Atlassian", "url": "https://www.atlassian.com/legal/subprocessors",
     ...
     "accent": "bg-blue-100 text-blue-700", "verified": True},
    {"slug": "notion", "name": "Notion", "url": "https://www.notion.com/subprocessors",
     "description": "Docs and internal wiki", "category": "Workplace",
     "accent": "bg-slate-200 text-slate-800", "verified": False},
    {"slug": "intercom", "name": "Intercom", "url": "https://www.intercom.com/legal/subprocessors",
     "description": "Customer support and messaging", "category": "Workplace",
     "accent": "bg-indigo-100 text-indigo-700", "verified": False},
    {"slug": "hubspot", "name": "HubSpot", "url": "https://legal.hubspot.com/sub-processors",
